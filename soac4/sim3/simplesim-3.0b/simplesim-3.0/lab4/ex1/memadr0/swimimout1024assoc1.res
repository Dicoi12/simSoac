...
sim: command line: ./sim-spred -redir:sim ./lab4/ex1/memadr0/swimimout1024assoc1.res -lvpt 1024 -assoc 1 -contextual 0 -memaddr 0 -pred 1 -max:inst 5000000 ./in/swim.ss 

sim: simulation started @ Tue Apr  1 14:47:37 2025, options follow:
...
# -redir:sim     ./lab4/ex1/memadr0/swimimout1024assoc1.res # redirect simulator output to file (non-interactive only)
...
valuePrediction              314031 # total number of correctly predicted values
...
classifiedPred               316881 # number of loads classified as predictable
classifiedUnpred             665465 # number of loads classified as unpredictable
predictable                  314031 # correctly classified predictable loads
unpredictable                648937 # correctly classified unpredictable loads
loadValueLocality                 0 # total number of loads executed
predictedValue               314031 # total number of predicted values
