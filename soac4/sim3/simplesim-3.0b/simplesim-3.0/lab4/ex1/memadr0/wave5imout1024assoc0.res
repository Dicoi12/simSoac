...
sim: command line: ./sim-spred -redir:sim ./lab4/ex1/memadr0/wave5imout1024assoc0.res -lvpt 1024 -assoc 0 -contextual 0 -memaddr 0 -pred 1 -max:inst 5000000 ./in/wave5.ss 

sim: simulation started @ Tue Apr  1 14:47:21 2025, options follow:
...
# -redir:sim     ./lab4/ex1/memadr0/wave5imout1024assoc0.res # redirect simulator output to file (non-interactive only)
...
valuePrediction              765151 # total number of correctly predicted values
...
classifiedPred               770328 # number of loads classified as predictable
classifiedUnpred             102970 # number of loads classified as unpredictable
predictable                  765151 # correctly classified predictable loads
unpredictable                 91550 # correctly classified unpredictable loads
loadValueLocality                 0 # total number of loads executed
predictedValue               765151 # total number of predicted values
