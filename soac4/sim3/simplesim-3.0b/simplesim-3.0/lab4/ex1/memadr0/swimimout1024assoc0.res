...
sim: command line: ./sim-spred -redir:sim ./lab4/ex1/memadr0/swimimout1024assoc0.res -lvpt 1024 -assoc 0 -contextual 0 -memaddr 0 -pred 1 -max:inst 5000000 ./in/swim.ss 

sim: simulation started @ Tue Apr  1 14:47:28 2025, options follow:
...
# -redir:sim     ./lab4/ex1/memadr0/swimimout1024assoc0.res # redirect simulator output to file (non-interactive only)
...
valuePrediction              423342 # total number of correctly predicted values
...
classifiedPred               430664 # number of loads classified as predictable
classifiedUnpred             253361 # number of loads classified as unpredictable
predictable                  423342 # correctly classified predictable loads
unpredictable                130253 # correctly classified unpredictable loads
loadValueLocality                 0 # total number of loads executed
predictedValue               423342 # total number of predicted values
