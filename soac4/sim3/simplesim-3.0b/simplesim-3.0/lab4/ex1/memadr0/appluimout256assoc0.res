...
sim: command line: ./sim-spred -redir:sim ./lab4/ex1/memadr0/appluimout256assoc0.res -lvpt 256 -assoc 0 -contextual 0 -memaddr 0 -pred 1 -max:inst 5000000 ./in/applu.ss 
...
# -redir:sim     ./lab4/ex1/memadr0/appluimout256assoc0.res # redirect simulator output to file (non-interactive only)
...
valuePrediction                 327 # total number of correctly predicted values
...
classifiedPred                  335 # number of loads classified as predictable
classifiedUnpred                463 # number of loads classified as unpredictable
predictable                     327 # correctly classified predictable loads
unpredictable                   280 # correctly classified unpredictable loads
