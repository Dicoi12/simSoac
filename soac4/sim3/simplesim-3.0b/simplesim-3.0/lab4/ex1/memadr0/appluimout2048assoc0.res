...
sim: command line: ./sim-spred -redir:sim ./lab4/ex1/memadr0/appluimout2048assoc0.res -lvpt 2048 -assoc 0 -contextual 0 -memaddr 0 -pred 1 -max:inst 5000000 ./in/applu.ss 
...
# -redir:sim     ./lab4/ex1/memadr0/appluimout2048assoc0.res # redirect simulator output to file (non-interactive only)
...
valuePrediction                 618 # total number of correctly predicted values
...
classifiedPred                  662 # number of loads classified as predictable
classifiedUnpred                894 # number of loads classified as unpredictable
predictable                     618 # correctly classified predictable loads
unpredictable                   482 # correctly classified unpredictable loads
