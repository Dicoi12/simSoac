...
sim: command line: ./sim-spred -redir:sim ./lab4/ex1/memadr0/appluimout128assoc1.res -lvpt 128 -assoc 1 -contextual 0 -memaddr 0 -pred 1 -max:inst 5000000 ./in/applu.ss 
...
# -redir:sim     ./lab4/ex1/memadr0/appluimout128assoc1.res # redirect simulator output to file (non-interactive only)
...
valuePrediction                 134 # total number of correctly predicted values
...
classifiedPred                  137 # number of loads classified as predictable
classifiedUnpred               1415 # number of loads classified as unpredictable
predictable                     134 # correctly classified predictable loads
unpredictable                  1330 # correctly classified unpredictable loads
