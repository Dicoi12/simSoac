...
sim: command line: ./sim-spred -redir:sim ./lab4/ex1/memadr0/wave5imout1024assoc1.res -lvpt 1024 -assoc 1 -contextual 0 -memaddr 0 -pred 1 -max:inst 5000000 ./in/wave5.ss 

sim: simulation started @ Tue Apr  1 14:47:33 2025, options follow:
...
# -redir:sim     ./lab4/ex1/memadr0/wave5imout1024assoc1.res # redirect simulator output to file (non-interactive only)
...
valuePrediction              354747 # total number of correctly predicted values
...
classifiedPred               362812 # number of loads classified as predictable
classifiedUnpred             514002 # number of loads classified as unpredictable
predictable                  354747 # correctly classified predictable loads
unpredictable                505152 # correctly classified unpredictable loads
loadValueLocality                 0 # total number of loads executed
predictedValue               354747 # total number of predicted values
