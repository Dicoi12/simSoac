...
sim: command line: ./sim-spred -redir:sim ./lab4/ex1/memadr0/appluimout1024assoc1.res -lvpt 1024 -assoc 1 -contextual 0 -memaddr 0 -pred 1 -max:inst 5000000 ./in/applu.ss 
...
# -redir:sim     ./lab4/ex1/memadr0/appluimout1024assoc1.res # redirect simulator output to file (non-interactive only)
...
valuePrediction                 143 # total number of correctly predicted values
...
classifiedPred                  152 # number of loads classified as predictable
classifiedUnpred               1676 # number of loads classified as unpredictable
predictable                     143 # correctly classified predictable loads
unpredictable                  1578 # correctly classified unpredictable loads
