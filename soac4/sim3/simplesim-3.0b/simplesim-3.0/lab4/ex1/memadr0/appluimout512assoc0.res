...
sim: command line: ./sim-spred -redir:sim ./lab4/ex1/memadr0/appluimout512assoc0.res -lvpt 512 -assoc 0 -contextual 0 -memaddr 0 -pred 1 -max:inst 5000000 ./in/applu.ss 
...
# -redir:sim     ./lab4/ex1/memadr0/appluimout512assoc0.res # redirect simulator output to file (non-interactive only)
...
valuePrediction                 484 # total number of correctly predicted values
...
classifiedPred                  500 # number of loads classified as predictable
classifiedUnpred                635 # number of loads classified as unpredictable
predictable                     484 # correctly classified predictable loads
unpredictable                   360 # correctly classified unpredictable loads
