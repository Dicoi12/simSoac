...
sim: command line: ./sim-spred -redir:sim ./lab4/ex1/memadr0/appluimout1024assoc0.res -lvpt 1024 -assoc 0 -contextual 0 -memaddr 0 -pred 1 -max:inst 5000000 ./in/applu.ss 
...
# -redir:sim     ./lab4/ex1/memadr0/appluimout1024assoc0.res # redirect simulator output to file (non-interactive only)
...
valuePrediction                 557 # total number of correctly predicted values
...
classifiedPred                  582 # number of loads classified as predictable
classifiedUnpred                781 # number of loads classified as unpredictable
predictable                     557 # correctly classified predictable loads
unpredictable                   434 # correctly classified unpredictable loads
