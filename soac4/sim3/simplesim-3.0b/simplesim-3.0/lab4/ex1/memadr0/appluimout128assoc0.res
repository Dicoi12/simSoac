...
sim: command line: ./sim-spred -redir:sim ./lab4/ex1/memadr0/appluimout128assoc0.res -lvpt 128 -assoc 0 -contextual 0 -memaddr 0 -pred 1 -max:inst 5000000 ./in/applu.ss 
...
# -redir:sim     ./lab4/ex1/memadr0/appluimout128assoc0.res # redirect simulator output to file (non-interactive only)
...
valuePrediction                 249 # total number of correctly predicted values
...
classifiedPred                  257 # number of loads classified as predictable
classifiedUnpred                311 # number of loads classified as unpredictable
predictable                     249 # correctly classified predictable loads
unpredictable                   194 # correctly classified unpredictable loads
