...
sim: command line: ./sim-spred -redir:sim ./lab4/ex1/memadr0/swimimout128assoc0.res -lvpt 128 -assoc 0 -contextual 0 -memaddr 0 -pred 1 -max:inst 5000000 ./in/swim.ss 
...
# -redir:sim     ./lab4/ex1/memadr0/swimimout128assoc0.res # redirect simulator output to file (non-interactive only)
...
valuePrediction                 155 # total number of correctly predicted values
...
classifiedPred                  157 # number of loads classified as predictable
classifiedUnpred              20824 # number of loads classified as unpredictable
predictable                     155 # correctly classified predictable loads
unpredictable                  7330 # correctly classified unpredictable loads
loadValueLocality                 0 # total number of loads executed
predictedValue                  155 # total number of predicted values
