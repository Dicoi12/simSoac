...
sim: command line: ./sim-spred -redir:sim ./lab4/ex2/wave5_lvpt512_pattern1_assoc1.res -lvpt 512 -assoc 1 -contextual 1 -pattern 1 -memaddr 0 -max:inst 5000000 ./in/wave5.ss 

sim: simulation started @ Tue Apr  1 12:54:43 2025, options follow:
...
# -redir:sim     ./lab4/ex2/wave5_lvpt512_pattern1_assoc1.res # redirect simulator output to file (non-interactive only)
