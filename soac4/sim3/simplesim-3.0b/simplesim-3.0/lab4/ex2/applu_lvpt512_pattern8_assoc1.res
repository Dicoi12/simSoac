...
sim: command line: ./sim-spred -redir:sim ./lab4/ex2/applu_lvpt512_pattern8_assoc1.res -lvpt 512 -assoc 1 -contextual 1 -pattern 8 -memaddr 0 -max:inst 5000000 ./in/applu.ss 
...
# -redir:sim     ./lab4/ex2/applu_lvpt512_pattern8_assoc1.res # redirect simulator output to file (non-interactive only)
