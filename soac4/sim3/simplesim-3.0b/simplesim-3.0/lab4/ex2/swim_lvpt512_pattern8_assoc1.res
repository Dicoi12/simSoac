...
sim: command line: ./sim-spred -redir:sim ./lab4/ex2/swim_lvpt512_pattern8_assoc1.res -lvpt 512 -assoc 1 -contextual 1 -pattern 8 -memaddr 0 -max:inst 5000000 ./in/swim.ss 

sim: simulation started @ Tue Apr  1 12:54:48 2025, options follow:
...
# -redir:sim     ./lab4/ex2/swim_lvpt512_pattern8_assoc1.res # redirect simulator output to file (non-interactive only)
