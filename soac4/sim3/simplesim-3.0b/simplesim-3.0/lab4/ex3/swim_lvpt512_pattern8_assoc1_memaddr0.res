...
sim: command line: ./sim-spred -redir:sim ./lab4/ex3/swim_lvpt512_pattern8_assoc1_memaddr0.res -lvpt 512 -assoc 1 -contextual 2 -pattern 8 -memaddr 0 -max:inst 5000000 ./in/swim.ss 

sim: simulation started @ Tue Apr  1 12:58:52 2025, options follow:
...
# -redir:sim     ./lab4/ex3/swim_lvpt512_pattern8_assoc1_memaddr0.res # redirect simulator output to file (non-interactive only)
