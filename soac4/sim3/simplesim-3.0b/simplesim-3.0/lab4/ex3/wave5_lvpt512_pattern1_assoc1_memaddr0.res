...
sim: command line: ./sim-spred -redir:sim ./lab4/ex3/wave5_lvpt512_pattern1_assoc1_memaddr0.res -lvpt 512 -assoc 1 -contextual 2 -pattern 1 -memaddr 0 -max:inst 5000000 ./in/wave5.ss 

sim: simulation started @ Tue Apr  1 12:58:47 2025, options follow:
...
# -redir:sim     ./lab4/ex3/wave5_lvpt512_pattern1_assoc1_memaddr0.res # redirect simulator output to file (non-interactive only)
