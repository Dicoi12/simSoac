...
sim: command line: ./sim-vpred -redir:sim ./lab4/ex4/swim_Incremental_lvpt512_assoc1_memaddr0.res -lvpt 512 -assoc 1 -contextual 1 -memaddr 0 -max:inst 5000000 ./in/swim.ss 
...
# -redir:sim     ./lab4/ex4/swim_Incremental_lvpt512_assoc1_memaddr0.res # redirect simulator output to file (non-interactive only)
