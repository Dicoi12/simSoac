...
sim: command line: ./sim-vpred -redir:sim ./lab4/ex4/apsi_Hybrid_lvpt512_assoc1_memaddr1.res -lvpt 512 -assoc 1 -contextual 3 -memaddr 1 -max:inst 5000000 ./in/apsi.ss 

sim: simulation started @ Tue Apr  1 13:31:24 2025, options follow:
...
# -redir:sim     ./lab4/ex4/apsi_Hybrid_lvpt512_assoc1_memaddr1.res # redirect simulator output to file (non-interactive only)
...
-contextual                 3 # predictor type {0-stride| 1-contextual| 2-hybrid}
