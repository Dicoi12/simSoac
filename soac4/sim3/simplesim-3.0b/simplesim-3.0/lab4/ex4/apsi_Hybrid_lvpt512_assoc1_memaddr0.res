...
sim: command line: ./sim-vpred -redir:sim ./lab4/ex4/apsi_Hybrid_lvpt512_assoc1_memaddr0.res -lvpt 512 -assoc 1 -contextual 3 -memaddr 0 -max:inst 5000000 ./in/apsi.ss 

sim: simulation started @ Tue Apr  1 13:31:15 2025, options follow:
...
# -redir:sim     ./lab4/ex4/apsi_Hybrid_lvpt512_assoc1_memaddr0.res # redirect simulator output to file (non-interactive only)
