...
sim: command line: ./sim-vpred -redir:sim ./lab4/ex4/apsi_Contextual_lvpt512_assoc1_memaddr1.res -lvpt 512 -assoc 1 -contextual 2 -memaddr 1 -max:inst 5000000 ./in/apsi.ss 

sim: simulation started @ Tue Apr  1 13:31:21 2025, options follow:
...
# -redir:sim     ./lab4/ex4/apsi_Contextual_lvpt512_assoc1_memaddr1.res # redirect simulator output to file (non-interactive only)
