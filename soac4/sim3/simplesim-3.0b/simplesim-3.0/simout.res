...
sim: command line: ./sim-spred -redir:sim simout.res -redir:prog progout.res -contextual 2 -pred 3 -reg 31 -pattern 4 -history 256 -max:inst 10000000 ./in/applu.ss 

sim: simulation started @ Tue Apr  1 11:46:55 2025, options follow:
...
-pred                       3 # what to do {0-not distinct locality| 1-prediction| 2-distinct locality| 3-register prediction}
-assoc                      1 # table type {0-dirrect mapped| 1-associative}
-history                  256 # maximum number of values memorized for an address
...
-reg                       31 # which register? If it's 0, all registers are used
...
sim_num_insn                  17411 # total number of instructions executed
sim_num_refs                   7290 # total number of loads and stores executed
sim_elapsed_time                  1 # total simulation time in seconds
sim_num_loads                   429 # total number of loads executed
loadValueLocality                 0 # total number of before seen load values
valuePrediction                  57 # total number of correctly predicted values
...
classifiedPred                   75 # number of loads classified as predictable
classifiedUnpred                353 # number of loads classified as unpredictable
predictable                      57 # correctly classified predictable loads
unpredictable                   295 # correctly classified unpredictable loads
loadValueLocality                 0 # total number of loads executed
sim_inst_rate            17411.0000 # simulation speed (in insts/sec)
sim_num_branches               3329 # total number of branches executed
sim_IPB                      5.2301 # instruction per branch
bpred_bimod.lookups            3329 # total number of bpred lookups
bpred_bimod.updates            3329 # total number of updates
bpred_bimod.addr_hits          2624 # total number of address-predicted hits
bpred_bimod.dir_hits           2904 # total number of direction-predicted hits (includes addr-hits)
bpred_bimod.misses              425 # total number of misses
...
bpred_bimod.bpred_addr_rate    0.7882 # branch address-prediction rate (i.e., addr-hits/updates)
bpred_bimod.bpred_dir_rate    0.8723 # branch direction-prediction rate (i.e., all-hits/updates)
