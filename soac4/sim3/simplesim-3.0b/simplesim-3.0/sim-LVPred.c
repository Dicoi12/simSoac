...
"  Predictor `comb' combines a bimodal and a 2-level predictor.\n"
  ...
  opt_reg_uint(odb, "-contor:LD", "maximum number of inst's to execute",
          &opt_load, /* default */0,
          /* print */TRUE, /* format */NULL);
  opt_reg_uint(odb, "-contor:LD:inst", "maximum number of inst's to execute",
          &opt_load, /* default */0,
          /* print */TRUE, /* format */NULL);
...
{
  stat_reg_counter(sdb, "contor_loads",
    "total number of contor_Loads",
    &contor_loads, 0, NULL);
  stat_reg_counter(sdb, "contor_stores",
      "total number of contor_stores",
